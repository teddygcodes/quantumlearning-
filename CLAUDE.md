...
- `experiment-ui.js` provides shared components: `GridCanvas`, `PhysicsBeam`, `BlochSphere`, `HistogramRenderer`, `CircuitSimulator`, `createDragHandler`, `animateValue`, `showToast`
...
Full spec for all 20 experiments is in `EXPERIMENT_SPEC.md` at the project root. It contains detailed game mechanics, completion criteria, and pedagogical rationale for each experiment. Refer to it when building Sessions 5-7.
