...
## Cache busting
ES module imports in app.js use query params: `./chapters.js?v=14`, `./problems.js?v=13`, `./templates.js?v=9`, `./keyboard.js?v=2`, `./experiments.js?v=4`, `./experiment-ui.js?v=3`.
Bump these when modifying those files. Also bump `app.js?v=N` in index.html (currently v=50).
