...
- `static/experiment-ui.js` — Shared experiment components (GridCanvas, PhysicsBeam, BlochSphere, HistogramRenderer, drag, tween, toast)
...
## Cache busting
ES module imports in app.js use query params: `./chapters.js?v=13`, `./problems.js?v=13`, `./templates.js?v=9`, `./keyboard.js?v=2`, `./experiments.js?v=4`, `./experiment-ui.js?v=3`.
Bump these when modifying those files. Also bump `app.js?v=N` in index.html (currently v=49).
...
- `experiment-ui.js` provides shared components: `GridCanvas`, `PhysicsBeam`, `BlochSphere`, `HistogramRenderer`, `createDragHandler`, `animateValue`, `showToast`
...
Full spec for all 20 experiments is in `EXPERIMENT_SPEC.md` at the project root. It contains detailed game mechanics, completion criteria, and pedagogical rationale for each experiment. Refer to it when building Sessions 3-7.
